        ...
        class chat_area(gr.Blocks):
                ...
                while output == "":
                    ...
                    class llm_core_request(Thread):
                        def run(self):
                            ...
                            llm = clients[usage].chat.completions.create(messages=input,model=models[usage],max_completion_tokens=10000,seed=seed)
                            print(llm)
            ...
            def request_click(self):
                ...
                if self.usage == 0:
                    ...
                    self.messages = [self.generate(global_messages, self.usage)[-1]]
                self.request_state = False
